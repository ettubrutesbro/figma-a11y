...
// figma.showUI('<b> Made some nodes </b>', { width: 400, height: 200 })
// Calls to "parent.postMessage" from within the HTML page will trigger this
// callback. The callback will be passed the "pluginMessage" property of the
// posted message.
console.log(figma.currentPage.selection[0].fills[0]);
console.log(figma.currentPage.selection[1].fills[0]);
